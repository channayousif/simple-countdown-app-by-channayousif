      ...
      <div className="bg-blue-200 dark:bg-gray-800 shadow-lg rounded-lg p-8 w-full max-w-md">
        ...
        <div className="flex items-center mb-6">
          <Input
            ...
            className="flex-1 mr-4 rounded-md border-gray-800 text-gray-900 dark:border-gray-300 dark:bg-gray-700 dark:text-gray-200"
          />
          <Button
        ...
        <div className="flex justify-center gap-4">
          <Button
            onClick={handleStart}
            variant="outline"
            className="text-gray-800 border-gray-800 dark:text-gray-200"
          >
